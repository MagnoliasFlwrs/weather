import { calculateDewPoint, calculatePressure, getCurrentDateTime, getWeatherForecastData, getWindDirection } from "./utils.js";
    ...
    widget.insertAdjacentHTML(
        ...
        <div class="widget__today">
            <div class="widget__date-block">
                <p class="widget__date">${currentDate.dayOfMonth} ${currentDate.month} ${currentDate.year}  </p>
                <p class="widget__time">${currentDate.hours}:${currentDate.minutes}</p>
                <p class="widget__day">${currentDate.dayOfWeek}</p>
            </div>
    ...
    widget.insertAdjacentHTML(
        ...
        <div class="widget__other">
            ...
            <div class="widget__pressure">
                ...
                <p class="widget__pressure-value">${calculatePressure(data.main.pressure)}</p>
